        ...
        <img style={{marginLeft:"22.2px"}} src={tag} alt="atg"/>
                    ...
                    <FormControlLabel className='color'  aria-labelledby='last' value="3 Months Subscription -18401"   control={<Radio />} label={<Typography sx={{
                        ...
                        color:"#3C4852"
                          ...
                          {value === "Limited time offer -18401 Offer valid till 25th March 2023" ? <div className='red'  style={{display:"flex",justifyContent:"space-between",marginTop:"14px",marginBottom:"20px"}}>
                            <Typography sx={{
                                color:"#DE4313",
                                fontSize:"16px",
                                fontStyle:"normal",
